...
var (
	...
	graphURL   = "http://s3.amazonaws.com/store.carml.org/models/uff/resnet50_uff/resnet50.uff"
...
func main() {
	...
	dir := filepath.Join(baseDir, model+"_uff")
	graph := filepath.Join(dir, model+".uff")
